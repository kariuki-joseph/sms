            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select
                  ...
                  class="form-control"
                  :class="{
                    'is-invalid': form.errors.has('class_teacher'),
                  }"
                >
...
export default {
  ...
  methods: {
    ...
    getClasses(page = 1) {
      axios
        .get("/classes?page=" + page + "&rec_count=" + this.active_record_count)
        .then((response) => {
  ...
  created() {
    ...
    Fire.$on("searching:classes", () => {
      let q = this.search;
      axios
        .get("classes/find?q=" + q + "&rec_count=" + this.active_record_count)
        .then((resp) => {
          //create a log
          this.$parent.createLog(
