  ...
  <div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="./img/logo.jpg" alt="SMS Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <router-link to="/users/types" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/classes" class="nav-link">
                <i class="nav-icon fas fa-school white"></i>
                <p>
                  Classes
                </p>
              </router-link>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <router-link to="/fees/payable" class="nav-link">
                    <i class="fas fa-briefcase white"></i>
                    <p>Payable Fees</p>
                  </router-link>
                </li>
